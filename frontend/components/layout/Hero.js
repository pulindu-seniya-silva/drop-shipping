...
export default function Hero() {
  return (
    <section className="grid grid-cols-1 md:grid-cols-2 gap-4 items-center px-4 md:px-8">
      <div className="max-w-lg -ml-8">
        <h1 className="text-3xl md:text-4xl font-semibold">Stand out from the crowd</h1>
        <p className="my-4 text-gray-500">
          Find your unique path to fitness with top-notch health and wellness gear at ClickShop Express.
        </p>
        <div className="flex flex-wrap gap-4 mt-3">
          <button className="bg-primary flex items-center gap-2 text-white px-6 py-2 rounded-full -ml-1">
            Shop Now
            <Right />
          </button>
